...
/// If the text symbol that is compared with the rightmost pattern symbol does not occur in the pattern at all,
/// then the pattern can be shifted by m positions behind this text symbol.
/// Time complexity:
/// Preprocessing: O(m^2), comparison: O(mn), space:  O(m + a),
/// where m - pattern length, n - text length, a - alphabet length.
/// Source:
...
public static class BoyerMoore
{
    ...
    /// <returns>Array of the named position for each symbol of the alphabet.</returns>
