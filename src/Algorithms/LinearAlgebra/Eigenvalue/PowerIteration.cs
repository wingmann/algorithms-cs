...
public static class PowerIteration
{
        ...
        double error = 0.00001)
    {
        ...
        do
        {
            ...
            currentEigenVector = currentEigenVector
                .Select(x => x / eigenNorm)
                .ToArray();
        }
    ...
    /// The length of the start vector doesn't equal the size of the source matrix.
    /// </exception>
    public static (double eigenvalue, double[] eigenvector) Dominant(double[,] source, double error = 0.000_01) =>
